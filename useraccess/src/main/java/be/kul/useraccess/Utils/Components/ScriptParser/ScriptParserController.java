package be.kul.useraccess.Utils.Components.ScriptParser;

import be.kul.useraccess.Entity.ScriptSummary;
import be.kul.useraccess.Utils.Components.ScriptParser.Antlr.RScriptLexer;
import be.kul.useraccess.Utils.Components.ScriptParser.Antlr.RScriptParser;
import be.kul.useraccess.Utils.Components.ScriptParser.Antlr.impl.RScriptBaseVisitorImpl;
...
import be.kul.useraccess.Utils.Components.ScriptParser.SupportedFunctions.SupportedFunctionFingerPrint;
...
public class ScriptParserController {
    public ScriptSummary generateAnonymizationSummary(String scriptString) {
        ...
        //Generate the anonymization information for the datasets
        //TODO

        //Generate the anonymization information for each function
        //TODO
